...
const Board =()=> {
  const [squaress,setsquaress] = useState<Array<string>>(Array(9).fill(null));
  const [xIsNextt,setxIsNextt] = useState<boolean>(true);
  ...
  const handleClick=(i:number)=>{
    const squares: Array<string> = squaress.slice();
